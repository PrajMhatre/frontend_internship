...
function PostInternships() {
  ...
  const sendData = (e) => {
    ...
    if (
      ...
      alert(t('postInternships.fillBlanksAlert'));
    } else {
      const bodyJson = {
        title: title,
        company: companyName,
        ...
        perks: perks,
        numberOfopning: numberOfOpening, // Corrected typo: numberOfopning to numberOfOpening
        stipend: stipend,
        StartDate: startDate,
      ...
      axios
        .post('https://backend-internship.onrender.com/api/internship', bodyJson)
        .then((res) => {
          console.log(res.data);
          alert(t('postInternships.successMessage'));
          navigate('/AdminPanel');
        })
        .catch((err) => {
          console.log(err);
        ...
        <form className="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2" onSubmit={sendData}>
          <div>
            <label htmlFor="title" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.title')}
            </label>
            <input
              name="title"
              value={title}
          ...
          <div>
            <label htmlFor="company-name" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.companyName')}
            </label>
            <input
              name="company-name"
              value={companyName}
          ...
          <div className="sm:col-span-2">
            <label htmlFor="Location" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.location')}
            </label>
            <input
              name="Location"
              value={location}
          ...
          <div className="sm:col-span-2">
            <label htmlFor="category" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.category')}
            </label>
            <input
              name="category"
              value={category}
          ...
          <div className="sm:col-span-2">
            <label htmlFor="aboutCompany" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.aboutCompany')}
            </label>
            <input
              name="aboutCompany"
              value={aboutCompany}
          ...
          <div className="sm:col-span-2">
            <label htmlFor="aboutInternship" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.aboutInternship')}
            </label>
            <textarea
          ...
          <div className="sm:col-span-2">
            <label htmlFor="Whocanapply" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.whoCanApply')}
            </label>
            <textarea
              name="Whocanapply"
              value={whoCanApply}
          ...
          <div className="sm:col-span-2">
            <label htmlFor="perks" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.perks')}
            </label>
            <input
              name="perks"
              value={perks}
          ...
          <div className="sm:col-span-2">
            <label htmlFor="numberOfOpening" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.numberOfOpening')}
            </label>
            <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="stipend" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.stipend')}
            </label>
            <input
              name="stipend"
              value={stipend}
          ...
          <div className="sm:col-span-2">
            <label htmlFor="startDate" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">
              {t('postInternships.fields.startDate')}
            </label>
            <input
              type="date"
              value={startDate}
          ...
          <div className="sm:col-span-2">
            <label htmlFor="additionalInfo" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">{t('postInternships.fields.additionalInfo')}</label>
          ...
          <button className="hover:bg-blue-600" type="submit">{t('postInternships.postInternship')}</button>
        </form>
      </div>
    </div>
  );
