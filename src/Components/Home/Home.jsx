    ...
    return (
        <>
            <h1 className='text-center text-3xl font-bold'>
                {t('home.makeYourDreamCareer')}
            </h1>
            <p className='text-center text-lg font-bold'>
                {t('home.trendingOnInternzone')}
            </p>
            ...
            <div className="infoys">
                <div className="info-intern">
                    ...
                    <div className="categories flex flex-wrap mt-14">
                        ...
                        <span className={`category mr-4 ml-6 ${selectedCategory === 'Big Brands' ? 'bg-blue-500 text-white' : ""}`} onClick={() => setSelectedCategory('Big Brands')}>
                            {t('home.bigBrands')}
                        </span>
                        <span className={`category mr-4 ml-6 ${selectedCategory === "Work From Home" ? 'bg-blue-500 text-white' : ""}`} onClick={() => setSelectedCategory("Work From Home")}>
                            {t('home.workFromHome')}
                        </span>
                        <span className={`category mr-4 ml-6 ${selectedCategory === "Part-time" ? 'bg-blue-500 text-white' : ""}`} onClick={() => setSelectedCategory("Part-time")}>
                            {t('home.partTime')}
                        </span>
                        <span className={`category mr-4 ml-6 ${selectedCategory === "MBA" ? 'bg-blue-500 text-white' : ""}`} onClick={() => setSelectedCategory("MBA")}>
                            {t('home.mba')}
                        </span>
                        <span className={`category mr-4 ml-6 ${selectedCategory === "Engineering" ? 'bg-blue-500 text-white' : ""}`} onClick={() => setSelectedCategory("Engineering")}>
                            {t('home.engineering')}
                        </span>
                        <span className={`category mr-4 ml-6 ${selectedCategory === "Media" ? 'bg-blue-500 text-white' : ""}`} onClick={() => setSelectedCategory("Media")}>
                            {t('home.media')}
                        </span>
                        <span className={`category mr-4 ml-6 ${selectedCategory === "Design" ? 'bg-blue-500 text-white' : ""}`} onClick={() => setSelectedCategory("Design")}>
                            {t('home.design')}
                        </span>
                        <span className={`category mr-4 ml-6 ${selectedCategory === "Data Science" ? 'bg-blue-500 text-white' : ""}`} onClick={() => setSelectedCategory("Data Science")}>
                            {t('home.dataScience')}
                        </span>
                    </div>
                </div>
                        ...
                        {filterInternships.map((data, index) => (
                            <div className="int-1 mt-6" key={index}>
                                <p className='mb-4 mt-3' id='boxer'>
                                    <i className='bi bi-arrow-up-right text-blue-500'></i> {t('home.companiesHiring')}
                                </p>
                                <p>{data.title}</p>
                                ...
                                <div className='more flex justify-between mt-6'>
                                    ...
                                    <Link to={`/detailInternship?q=${data._id}`}>
                                        <span className='text-blue-500 mr-2'>
                                            {t('home.register')} <i className='bi bi-chevron-right'></i>
                                        </span>
                                    </Link>
                                </div>
                            </div>
            ...
            <hr />
                ...
                <div className="text-block mt-5">
                    ...
                    <p>{t('home.newOpeningsEveryday')}</p>
                </div>
                <div className="text-block mt-5">
            ...
            <div className="logins flex h-32 mt-8">
                ...
                <div className="log flex">
                    <a href="/register" id='buttons' className="flex items-center bg-white h-9 justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                       ...
                       <p class="px-4 py-3 w-5/6 text-center text-sm text-gray-600 font-bold ">{t('home.signInWithGoogle')}</p>
                    </a>
                    <a to="/register">
